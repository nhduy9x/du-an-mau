...
if (isset($id)) {
  $setting=one('settings where id ='.$id);
}
?>
<!DOCTYPE html>
<html>
                ...
                <div class="basic-form">
                  ...
                  <div class="form-group row">
                                    <div class="col-sm-6" style="margin-left: 0px;">
                                        ...
                                        <div style="width: 100%;">
                                            <label class="col-form-label">Logo Text</label>
                                            <div class="col-form">
                                                <input class="form-control is-valid" id="name" name="name" type="text" value="<?=isset($setting) ? $setting['logo_text']:''?>">
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <input type="hidden" name="anh" value="<?=isset($setting)?$setting['logo_imgs']:''?>">
                                        ...
                                        <div style="width: 100%;">
                                           <label class="col-form-label">footer title</label>
                                            <input type="text" name="footer_title" class="form-control is-valid" value="<?=$setting['footer_title']?>">
                                      <span class="text-danger"><?=isset($error['footer_title'])?$error['footer_title']:''?></span>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div style="width: 100%;">
                                            ...
                                            <div class="col-form">
                                                <img id="asgnmnt_file_img" src="<?php if (isset($setting['images'])): ?>
                                                  ../<?=$setting['images']?>
                                                <?php else: ?>
                                    ...
                                    <div class="col-sm-6">
                                      <div style="width: 100%;">
                                           <label class="col-form-label">hien thi logo</label>
                                            <select name="choose_logo" class="form-control">
                                            <option value="">--chon--</option>
                                            <option value="1">--logo img--</option>
                                            <option value="2">--logo text--</option>
                                        

                                            </select>
                                        <span class="text-danger"><?=isset($error['choose_logo'])?$error['choose_logo']:''?></span>
                                      </div>
                                    </div>
