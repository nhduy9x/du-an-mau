...
if (!isset($_SESSION['auth'])) {
 ...
 $setting=one('settings where id =1');
?>
<!DOCTYPE html>
<html>
<head>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                      ...
                      <td><img src="../<?=$setting['logo_img']?>" width="50px"></td>
                      <td><?=isset(($setting['choose_logo']))?'logo image':'logo text'?></td>
                      <td><a href="form.php?id=<?=$setting['id']?>" class="btn btn-app" class="btn btn-success"><i class="fa fa-edit"></i>Edit</a> <a onclick="return confirmDel()" href="delete.php?delete=<?=$setting['id']?>" class="btn btn-app"><i class="fas fa-trash-alt" style="font-size: 20px; text-align: center;"></i><br>Delete</a></td>
                    </tr>
                </tbody>
